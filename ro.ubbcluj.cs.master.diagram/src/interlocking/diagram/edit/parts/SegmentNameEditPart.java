 ...
 * @generated
 */
public class SegmentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SegmentNameEditPart(View view) {
		super(view);
	}
			...
			parser = InterlockingParserProvider
					.getParser(
							...
							InterlockingVisualIDRegistry
									.getType(interlocking.diagram.edit.parts.SegmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
