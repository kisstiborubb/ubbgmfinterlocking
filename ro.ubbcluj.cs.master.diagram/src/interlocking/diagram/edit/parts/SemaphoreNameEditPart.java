 ...
 * @generated
 */
public class SemaphoreNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SemaphoreNameEditPart(View view) {
		super(view);
	}
			...
			parser = InterlockingParserProvider
					.getParser(
							...
							InterlockingVisualIDRegistry
									.getType(interlocking.diagram.edit.parts.SemaphoreNameEditPart.VISUAL_ID));
		}
		return parser;
	}
