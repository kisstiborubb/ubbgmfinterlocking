 ...
 * @generated
 */
public class SwichNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SwichNameEditPart(View view) {
		super(view);
	}
			...
			parser = InterlockingParserProvider
					.getParser(
							...
							InterlockingVisualIDRegistry
									.getType(interlocking.diagram.edit.parts.SwichNameEditPart.VISUAL_ID));
		}
		return parser;
	}
