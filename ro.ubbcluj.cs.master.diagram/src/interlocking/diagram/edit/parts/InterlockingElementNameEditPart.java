...
import interlocking.diagram.edit.policies.InterlockingTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InterlockingElementNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InterlockingElementNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new InterlockingTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return InterlockingElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = InterlockingParserProvider
					.getParser(
							InterlockingElementTypes.InterlockingElement_2004,
							getParserElement(),
							InterlockingVisualIDRegistry
									.getType(interlocking.diagram.edit.parts.InterlockingElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					InterlockingEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
