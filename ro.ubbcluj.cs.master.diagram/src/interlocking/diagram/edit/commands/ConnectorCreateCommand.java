...
public class ConnectorCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Connector newElement = InterlockingFactory.eINSTANCE.createConnector();

		InterlockingElement owner = (InterlockingElement) getElementToEdit();
		owner.getConnectors().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Connector newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
