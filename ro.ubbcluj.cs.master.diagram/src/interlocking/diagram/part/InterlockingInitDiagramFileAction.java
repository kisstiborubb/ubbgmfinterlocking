 ...
 * @generated
 */
public class InterlockingInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new InterlockingNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				InterlockingEditPart.MODEL_ID));
		InterlockingDiagramEditorUtil.runWizard(getShell(), wizard,
