 ...
 * @generated
 */
public class InterlockingViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return InterlockingEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = InterlockingVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = InterlockingVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!InterlockingElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != InterlockingVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!InterlockingEditPart.MODEL_ID
						.equals(InterlockingVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return SegmentEditPart.VISUAL_ID == visualID
				|| SemaphoreEditPart.VISUAL_ID == visualID
				|| SwichEditPart.VISUAL_ID == visualID
				|| InterlockingElementEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = InterlockingVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(InterlockingEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = InterlockingVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case SegmentEditPart.VISUAL_ID:
			return createSegment_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SemaphoreEditPart.VISUAL_ID:
			return createSemaphore_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SwichEditPart.VISUAL_ID:
			return createSwich_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case InterlockingElementEditPart.VISUAL_ID:
			return createInterlockingElement_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		case ConnectorEditPart.VISUAL_ID:
			return createConnector_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (InterlockingVisualIDRegistry.getVisualID(elementTypeHint)) {
		case InterlockingConnectionEditPart.VISUAL_ID:
			return createInterlockingConnection_4001(
	 ...
	 * @generated
	 */
	public Node createSegment_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(InterlockingVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSemaphore_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
	 ...
	 * @generated
	 */
	public Node createSwich_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
	 ...
	 * @generated
	 */
	public Node createInterlockingElement_2004(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createConnector_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(InterlockingVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createInterlockingConnection_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(InterlockingVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!InterlockingEditPart.MODEL_ID.equals(InterlockingVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", InterlockingEditPart.MODEL_ID); //$NON-NLS-1$
