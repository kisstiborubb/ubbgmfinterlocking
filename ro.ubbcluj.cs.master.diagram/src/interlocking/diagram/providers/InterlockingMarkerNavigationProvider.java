...
import interlocking.diagram.part.InterlockingDiagramEditorUtil;
 ...
 * @generated
 */
public class InterlockingMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = InterlockingDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			InterlockingDiagramEditorUtil.selectElementsInDiagram(editor,
