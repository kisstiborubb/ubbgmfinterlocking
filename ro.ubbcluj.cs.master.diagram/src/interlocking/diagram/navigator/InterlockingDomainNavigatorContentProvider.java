 ...
 * @generated
 */
public class InterlockingDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public InterlockingDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof InterlockingDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((InterlockingDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new InterlockingDomainNavigatorItem(
